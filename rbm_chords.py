...
songs = get_songs('krnb')  # These songs have already been converted from midi to msgpack
...
num_epochs = 500  # The number of training epochs that we are going to run.
...
with tf.Session() as sess:
    ...
    for i in range(sample.shape[0]):
        ...
        midi_manipulation.noteStateMatrixToMidi(S, "out/chords_{}".format(i))
